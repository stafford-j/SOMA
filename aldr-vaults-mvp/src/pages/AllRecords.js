...
const AllRecords = () => {
  ...
  const sortedRecords = [...sampleRecords].sort((a, b) => new Date(b.date) - new Date(a.date));
      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold heading-gradient mb-4">All Health Records</h1>
              <p className="text-aldr-gray">
                Complete view of all your health records ({sortedRecords.length} total)
              </p>
            </div>
            <Link
              to="/"
