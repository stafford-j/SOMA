 ...
 * 
 * A specialized navigation bar for the record creation form in Aldr Health Colleague.
  ...
  return (
    <div className="colleague-header">
      <div className="header-left">
        <img
          src="../assets/aldr-logo-hq.png"
          alt="Aldr Health Logo"
          className="colleague-logo"
        />
        <div>
          <h1 className="colleague-title">Aldr Health Colleague</h1>
