/**
 * Aldr Dashboard Template
 * 
 * A modern, Aldr-styled dashboard for health records displaying:
 * - Health Statistics
 * - Recent Records
...
const AldrDashboardTemplate = ({ records = [], loading = false, error = null, userId = "1234" }) => {
    ...
    <div className="dashboard-container">
      ...
      <div style={{
        ...
        <p style={{ marginTop: '0.5rem', fontSize: '0.8rem' }}>
          © 2025 Aldr Health. All rights reserved.
        </p>
      </div>
    </div>
  );
...
export default AldrDashboardTemplate;